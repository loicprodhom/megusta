...
public class MeGustaTools {
    public static void initializeEnvironment(IngredientRepository ingredientRepository,
        ...
        // Contains pestoContent = new
        // Contains((Ingredient)ingredientRepository.findByName("Pesto"), (Recipe)
        // recipeRepository.findByName("Pesto Pasta"), 6, (Unit)
        // unitRepository.findByName("Teaspoon")); contents.add(pestoContent);
        // containsRepository.save(pestoContent); Contains pastaContent = new
